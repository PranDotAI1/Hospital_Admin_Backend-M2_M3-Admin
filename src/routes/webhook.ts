...
import {
  ...
  onCarecontext,
  onConsentInit,
} from "../controllers/v2/webhook.controller";
import {
  consentOnFetchCallback,
  receivedConsentRequestStatus,
  // requestOnInitCallback,
...
// M3 Call back url
webook.post("/api/v3/hiu/consent/request/on-init", onConsentInit); // note - harshith
